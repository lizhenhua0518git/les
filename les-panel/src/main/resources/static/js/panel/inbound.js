...
function addData(data){
    ...
    for(var i =1;i<length+1;i++){
      ...
      var   tempHtml = ' <div class="layui-col-xs6">' +
          '        <div class="itemStore">' +
          '            <h4 class="title">入库总数量：'+item.receiveNum+'</h4>' +
          '            <div class="content">' +
          ...
          '                        <span class="layui-progress-text">'+item.qualifiedNum+'</span>' +
          '                    </div>' +
          '                    <div class="otherBar" style="min-width: '+item.otherRate+';">' +
          '                        <span class="layui-progress-text">'+item.surplusNum+'</span>' +
          '                    </div>' +
          '                </div>' +
          '            </div>' +
          '        </div>' +
    ...
    setInterval(listAllInBoundInfo, updateInterval);
