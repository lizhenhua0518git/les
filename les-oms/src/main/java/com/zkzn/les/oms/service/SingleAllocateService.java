 ...
 * @author wangzhou
 * @date 2020年8月10日
 * @Description:调拨订单管理service
 */
public interface SingleAllocateService {
	 ...
	 * @Author:wangzhou
	 * @date:2020年8月10日
	 * @Description:分页查询调拨订单
	 */
	PageInfo<SingleAllocate> listSingleAllocatePage(SingleAllocate singleAllocate);
