...
var timeNum = 0;
function queryInfo(){
 var url ="/iles/panel/queryYzZZAssemblePlane?storageLocation=1611&stationCode=GW09,GW10,GW11,GW12,GW13,GW14,GW15,GW16,GW17,11120303,01100000,11120405";
 ...
 $("#"+stationCode+"_sap_unfinish").text(Number(num)-Number(finishNum));
   ...
   var  value ="0.0";
	...
	$("#"+stationCode+"_sap").html("<div class='layui-progress-bar' lay-percent='"+value+"%'></div>");
 	...
 	var option = {
 			url:'/iles/panel/queryCarrierUseNum?warehouseCode=00500300',
 			type:'GET',
