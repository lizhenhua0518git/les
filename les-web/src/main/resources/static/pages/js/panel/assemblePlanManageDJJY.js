...
var timeNum = 0;
function queryArea(){
 var areaUrl ="/iles/panel/queryAssembleArea?storageLocation=1800,J003,1801";
 var bgImageAray = ["DJXBK-JPQ-A001",
"DJXBK-JPQ-A002",
"DJXBK-JPQ-B001",
"DJXBK-JPQ-B002",
"DJXBK-JPQ-C001",
		...
		if(area!=null){
			...
			if(tab[1]=="ZZ1"){
				...
				if($.inArray(areaCode,bgImageAray)<0){
					...
					$('#'+areaCode).html("<ul id='"+areaTab[1]+"' onclick=getCode('"+areaTab[1]+"')><li style='margin-top: -5px;'>"+areaName+"</li>" +
							"<li>"+areaTab[1]+"</li>" +
									"<li>"+tab3+"</li></ul>");
				}else{
					$('#'+areaCode).css("background","url('/iles/pages/img/gzxc_f1.png')no-repeat");
...
function locHtml(){
	$('#DJXBK-JPQ-A001').html("A001");
	$('#DJXBK-JPQ-A002').html("A002");
	$('#DJXBK-JPQ-B001').html("B001");
    $('#DJXBK-JPQ-B002').html("B002");
    $('#DJXBK-JPQ-C001').html("C001");
    $('#DJXBK-JPQ-C002').html("C002");
    $('#DJXBK-JPQ-D001').html("D001");
 	$('#DJXBK-JPQ-D002').html("D002");
    $('#DJXBK-JPQ-E001').html("E001");
    $('#DJXBK-JPQ-E002').html("E002");
    $('#DJXBK-JPQ-F001').html("F001");
    $('#DJXBK-JPQ-F002').html("F002");
 	$('#DJXBK-JPQ-G001').html("G001");
    $('#DJXBK-JPQ-G002').html("G002");
    $('#DJXBK-JPQ-H001').html("H001");
    $('#DJXBK-JPQ-H002').html("H002");
    $('#DJXBK-JPQ-I001').html("I001");
 	$('#DJXBK-JPQ-I002').html("I002");
    $('#DJXBK-JPQ-J001').html("J001");
    $('#DJXBK-JPQ-J002').html("J002");
    $('#DJXBK-JPQ-K001').html("K001");
    $('#DJXBK-JPQ-K002').html("K002");
    
    
 	
 	
 	$('DJXBK-JPQ-A001').css("background","");
 	$('DJXBK-JPQ-A002').css("background","");
	$('DJXBK-JPQ-B001').css("background","");
    $('DJXBK-JPQ-B002').css("background","");
    $('DJXBK-JPQ-C001').css("background","");
    $('DJXBK-JPQ-C002').css("background","");
    $('DJXBK-JPQ-D001').css("background","");
 	$('DJXBK-JPQ-D002').css("background","");
    $('DJXBK-JPQ-E001').css("background","");
    $('DJXBK-JPQ-E002').css("background","");
    $('DJXBK-JPQ-F001').css("background","");
    $('DJXBK-JPQ-F002').css("background","");
 	$('DJXBK-JPQ-G001').css("background","");
    $('DJXBK-JPQ-G002').css("background","");
    $('DJXBK-JPQ-H001').css("background","");
    $('DJXBK-JPQ-H002').css("background","");
    $('DJXBK-JPQ-I001').css("background","");
 	$('DJXBK-JPQ-I002').css("background","");
 	$('DJXBK-JPQ-J001').css("background","");
 	$('DJXBK-JPQ-J002').css("background","");
 	$('DJXBK-JPQ-K001').css("background","");
 	$('DJXBK-JPQ-K002').css("background","");
