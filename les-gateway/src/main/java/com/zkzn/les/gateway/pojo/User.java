...
import com.zkzn.les.gateway.util.PageCondition;
...
public class User  extends PageCondition {
	...
	public String toString() {
		return "User [id=" + id + ", userName=" + userName + ", userPassword="
				+ userPassword + ", oldPassWord=" + oldPassWord + ", phone="
				+ phone + ", orgId=" + orgId + ", orgCode=" + orgCode
				+ ", orgName=" + orgName + ", avatar=" + avatar + ", status="
				+ status + "]";
	}
