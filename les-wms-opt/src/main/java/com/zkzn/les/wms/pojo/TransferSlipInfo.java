...
public class TransferSlipInfo extends PageCondition {
    ...
    @ApiModelProperty(name = "storageBinId", value = "绑定的仓位表主键")
    private String storageBinId;
    @ApiModelProperty(name = "materialItemNo", value = "物料行号")
    private Integer materialItemNo;
    @ApiModelProperty(name = "sellOrder",value = "销售订单号")
    private String sellOrder;
    @ApiModelProperty(name = "sellOrderItem",value = "销售订单行项目号")
    private String sellOrderItem;
    @ApiModelProperty(name="stockType",value = "库存类型")
    private String stockType;
    @ApiModelProperty(name = "isSerial", value = "是否是序列号")
