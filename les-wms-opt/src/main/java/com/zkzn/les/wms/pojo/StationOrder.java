...
public class StationOrder extends PageCondition {
	...
	@ApiModelProperty(name="costCenterOrder", value="成本中心领料单号")
	private  String costCenterOrder;
	@ApiModelProperty(name="remark", value="备注")
	private String remark;
	@ApiModelProperty(name="busiType", value="业务类型")
	private int busiType;
	@ApiModelProperty(name="internalBillCode", value="内部订单号")
	private String internalBillCode;
	@ApiModelProperty(name="costCode",value = "成本中心编码")
