...
public final class FileUtil {
    ...
    /**.
     * 
     * 功能描述：构建ServletFileUpload对象
     * 作者：wangzhou
     * 时间：2018年6月29日
     * @return
     */
    public static ServletFileUpload getUpload() {
        ServletFileUpload upload = new ServletFileUpload(getFactory());
...
//        try {
//            if (file.getSize() > FileUtil.maxFileSize) {
//                logger.debug("保存文件失败！文件超出大小：" + FileUtil.maxFileSize);
//                return;
//            }
//            //FileUtils.copyInputStreamToFile(file.getInputStream(), new File(FileUtil.filePath + fileName));
//        } catch (IOException e) {
...
//     * @param fileName
//     */
//    public static void wirte(InputStream in, String fileName) {
//        try {
//            FileUtils.copyInputStreamToFile(in, new File(FileUtil.filePath + fileName));
//        } catch (IOException e) {
//            logger.debug("保存文件失败：" + e.getMessage());
//        }
//    }
